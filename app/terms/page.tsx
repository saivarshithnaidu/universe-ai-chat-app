...
export const metadata = {
    title: "Terms & Conditions – UniversalAI",
};
    ...
    return (
        <div className="min-h-screen bg-black text-white p-6 md:p-12">
            <div className="max-w-3xl mx-auto space-y-8">
                <h1 className="text-4xl font-bold mb-8">Terms & Conditions – UniversalAI</h1>

                <section className="space-y-4">
                    <p className="text-gray-300">
                        By using UniversalAI, you agree to the following terms:
                    </p>
                    <ul className="list-disc list-inside text-gray-300 space-y-2">
                        <li>UniversalAI provides AI-powered model comparison services.</li>
